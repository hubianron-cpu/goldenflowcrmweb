    ...
    <section className="section-pad border-y border-white/10 bg-white/[0.025]">
      <div className="container-shell">
        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-3">
          ...
          <article className="glass-panel rounded-lg border-gold-300/25 p-5">
          ...
          <article className="rounded-lg border border-gold-300/25 bg-gold-300/[0.08] p-5 shadow-gold">
        ...
        <div className="mt-5 grid gap-3 lg:grid-cols-3">
          {closingItems.map((item) => (
            <article key={item.title} className={`rounded-lg border p-4 ${item.tone}`}>
              ...
              <p className="mt-4 text-sm leading-6 text-zinc-400">{item.status}</p>
