import { AlertTriangle, CalendarX, CircleDollarSign, MessagesSquare } from "lucide-react";
...
const problems = [
  ...
  },
  {
    ...
    title: "לא יודעים מה באמת משתלם",
    text: "קשה לדעת איזה מקור לידים מחזיר כסף ואיפה כדאי להשקיע יותר.",
  },
];
    ...
    <section className="section-pad border-b border-white/10">
      <div className="container-shell">
        ...
        <p className="mt-8 max-w-3xl text-lg leading-8 text-zinc-300">
          GoldenFlow CRM נבנתה כדי להפוך את הבלגן הזה לתהליך ברור, פשוט ומדיד,
          בלי להעמיס על היום שלך עוד מערכת מסובכת.
        </p>
      </div>
    </section>
  );
